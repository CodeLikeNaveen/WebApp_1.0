...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "9059926d-c68f-4b32-9bc8-40ecb975ea56");
        ...
        >
            ...
            >
                ...
                <motion.button
                    ...
                    type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/70 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'
                >
                    Submit now
                    <MoveRight className='w-6 h-6 text-gray-100' />
                </motion.button>
